...
/* harmony import */ var _modules_header_burger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/header/burger */ "./js/modules/header/burger.js");
/* harmony import */ var _modules_catalog_catalog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/catalog/catalog */ "./js/modules/catalog/catalog.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    var burger = new _modules_header_burger__WEBPACK_IMPORTED_MODULE_1__["Burger"]();
    burger.init();
    var catalog = new _modules_catalog_catalog__WEBPACK_IMPORTED_MODULE_2__["Catalog"]();
    catalog.init();
    var form = new _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_3__["Form"]();
    window.form = form;
    form.init();
    var map = new _modules_map_map__WEBPACK_IMPORTED_MODULE_4__["Map"]();
    map.init();
  });
});
...
var Catalog = /*#__PURE__*/function () {
  ...
  _createClass(Catalog, [{
    ...
    value: function setTitleHeight() {
      this.cruiseCards.forEach(function (cruiseCard) {
        var content = cruiseCard.querySelector('.catalog__item-content-wrapper');
        var title = cruiseCard.querySelector('h3');
        var titleHeight = title.offsetHeight;
        content.style.setProperty('--titleHeight', "".concat(titleHeight, "px"));
      });
    }
  }, {
    key: "debounce",
    value: function debounce(callback) {
      var _this = this;
      var timeoutDelay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 100;
      var timeoutId;
      return function () {
      ...
      script.addEventListener('load', function () {
        ymaps.ready(function () {
          var myMap = new ymaps.Map('map', {
            center: [_this.CenterCoordinates.LAT, _this.CenterCoordinates.LNG],
            zoom: _this.mapZoom
          });
          var myPlacemark = new ymaps.Placemark([_this.MarkerCoordinates.LAT, _this.MarkerCoordinates.LNG], {
