...
/* harmony import */ var _modules_header_burger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/header/burger */ "./js/modules/header/burger.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    var burger = new _modules_header_burger__WEBPACK_IMPORTED_MODULE_0__["Burger"]();
    burger.init();
    var form = new _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_2__["Form"]();
    window.form = form;
    form.init();
    var map = new _modules_map_map__WEBPACK_IMPORTED_MODULE_3__["Map"]();
    map.init();
  });
});
